...
Topic.create!(question: "Which product has the most total carbohydrates?",
                 ...
                 test_field: "nf_total_carbohydrate_percent",
                 qtype: true)
